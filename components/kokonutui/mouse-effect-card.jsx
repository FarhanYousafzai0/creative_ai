    ...
    return (
        <Card
            ...
            <CardContent
                ...
                {topText && (
                    <div className="absolute top-6 left-6 z-10">
                        <div className="relative">
                            <div
                                className="absolute inset-0 bg-white/60 dark:bg-zinc-950/60 blur-lg rounded-lg" />
                            <div className="relative flex flex-col gap-1">
                                ...
                                {topSubtext && (
                                    <p
                                        className="text-xs font-medium text-zinc-600 dark:text-zinc-400 opacity-70">
                                        {topSubtext}
                                    </p>
                                )}
                            </div>
                ...
                <div
                    className="relative z-10 flex flex-col items-center justify-center h-full px-2">
                    <div className="flex flex-col items-center gap-6">
                        <div className="relative">
                            <div
                                className="absolute inset-0 bg-white/80 dark:bg-zinc-950/80 blur-2xl rounded-full" />
                            <h2
                                className="relative text-4xl font-bold text-zinc-900 dark:text-white text-center tracking-tight">
                                {title}
                            </h2>
                        </div>
                        {(subtitle || children) && (
                            <div className="relative">
                                <div
                                    className="absolute inset-0 bg-white/60 dark:bg-zinc-950/60 blur-xl rounded-lg" />
                                <p
                                    className="relative text-base text-zinc-700 dark:text-zinc-300 text-center leading-relaxed max-w-sm font-medium">
                                    {children || subtitle}
                                </p>
                            </div>
                        )}
                ...
                {footerText && (
                    <div className="absolute bottom-6 left-0 right-0 z-10 flex justify-center">
                        <div className="relative">
                            <div
                                className="absolute inset-0 bg-white/60 dark:bg-zinc-950/60 blur-lg rounded-full" />
                            <p
                                className="relative text-xs text-zinc-600 dark:text-zinc-400 font-medium px-4 py-1">
                                {footerText}
                            </p>
                        </div>
                    </div>
